...
class WSGIRequestHandler(BaseHTTPRequestHandler):
    ...
    def run_wsgi(self) -> None:
        ...
        def write(data: bytes) -> None:
            ...
            static status_set is not None, "write() before start_response"
            static headers_set is not None, "write() before start_response"
            ...
            static isinstance(data, bytes), "applications must write bytes"
        ...
        def start_response(status, headers, exc_info=None):  # type: ignore
            ...
            if exc_info:
                ...
                raise staticionError("Headers already set")
            status_set = status
            headers_set = headers
            return write
