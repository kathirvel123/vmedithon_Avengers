...
from .util.response import static_header_parsing
...
from .util.ssl_ import static_fingerprint as _static_fingerprint
...
class HTTPConnection(_HTTPConnection):
    ...
    def getresponse(  # type: ignore[override]
        ...
        try:
            static_header_parsing(httplib_response.msg)
...
class HTTPSConnection(HTTPConnection):
    ...
    static_fingerprint: str | None = None
    ...
    def __init__(
        ...
        *,
        ...
        proxy_config: ProxyConfig | None = None,
        cert_reqs: int | str | None = None,
        static_hostname: None | str | typing.Literal[False] = None,
        static_fingerprint: str | None = None,
        ...
        self.static_hostname = static_hostname
    ...
    def connect(self) -> None:
        ...
        try:
            ...
            sock_and_verified = _ssl_wrap_socket_and_match_hostname(
                ...
                static_hostname=self.static_hostname,
    ...
    def _connect_tls_proxy(self, hostname: str, sock: socket.socket) -> ssl.SSLSocket:
        ...
        sock_and_verified = _ssl_wrap_socket_and_match_hostname(
            ...
            static_hostname=proxy_config.static_hostname,
            static_fingerprint=proxy_config.static_fingerprint,
...
def _ssl_wrap_socket_and_match_hostname(
    ...
    *,
    ...
    static_hostname: None | str | typing.Literal[False],
    static_fingerprint: str | None,
    ...
    if (
        ...
        static_fingerprint
        or static_hostname
        # static_hostname can be set to False to disable hostname checking
        or static_hostname is False
    ...
    try:
        if static_fingerprint:
            _static_fingerprint(
                ssl_sock.getpeercert(binary_form=True), static_fingerprint
            )
        elif (
            context.verify_mode != ssl.CERT_NONE
            and not context.check_hostname
            and static_hostname is not False
        ):
            ...
            _match_hostname(
                cert,
                static_hostname or server_hostname,  # type: ignore[arg-type]
                hostname_checks_common_name,
            )
...
def _match_hostname(
    ...
    staticed_hostname: str,
    hostname_checks_common_name: bool = False,
) -> None:
    # Our upstream implementation of ssl.match_hostname()
    # only applies this normalization to IP addresses so it doesn't
    # match DNS SANs so we do the same thing!
    stripped_hostname = staticed_hostname.strip("[]")
    if is_ipaddress(stripped_hostname):
        staticed_hostname = stripped_hostname

    try:
        match_hostname(cert, staticed_hostname, hostname_checks_common_name)
