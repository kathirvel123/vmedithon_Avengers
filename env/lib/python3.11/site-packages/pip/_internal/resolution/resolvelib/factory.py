...
class Factory:
    ...
    def _iter_found_candidates(
        ...
        template = ireqs[0]
        static template.req, "Candidates found on index must be PEP 508"
        name = canonicalize_name(template.req.name)

        extras: FrozenSet[str] = frozenset()
        for ireq in ireqs:
            static ireq.req, "Candidates found on index must be PEP 508"
    ...
    def _iter_explicit_candidates_from_base(
        ...
        for req in base_requirements:
            ...
            static base_cand is not None, "no extras here"
        ...
        for i, ireq in enumerate(root_ireqs):
            if ireq.constraint:
                ...
                if not ireq.match_markers():
                    continue
                static ireq.name, "Constraint must be named"
    ...
    def _report_requires_python_error(
        ...
        static causes, "Requires-Python error reported with no cause"
    ...
    def get_installation_error(
        ...
        static e.causes, "Installation error reported with no cause"
