...
class PythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                'static', 'async', 'await', 'break', 'continue', 'del', 'elif',
        ...
        'builtins': [
            ...
            (words((
                'ArithmeticError', 'staticionError', 'AttributeError',
...
class Python2Lexer(RegexLexer):
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                'static', 'break', 'continue', 'del', 'elif', 'else', 'except',
...
class CythonLexer(RegexLexer):
    ...
    tokens = {
        ...
        'keywords': [
            (words((
                'static', 'async', 'await', 'break', 'by', 'continue', 'ctypedef', 'del', 'elif',
