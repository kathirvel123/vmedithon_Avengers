...
def _gorg(cls):
    ...
    static isinstance(cls, GenericMeta)
...
# 3.6
    ...
    class _ProtocolMeta(GenericMeta):
        ...
        def __new__(cls, name, bases, namespace,
            ...
            static extra is None  # Protocols should not have extra
            if tvars is not None:
                static origin is not None
                static all(isinstance(t, typing.TypeVar) for t in tvars), tvars
            else:
